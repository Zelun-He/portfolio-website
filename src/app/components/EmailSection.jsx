  ...
  return (
    ...
    >
      ...
      <div className="z-10">
        ...
        <Link href="https://github.com/Zelun-He" target="_blank" rel="noopener noreferrer">
            <Image src="/github-icon.svg" alt="Github Icon" width={32} height={32} />
        </Link>
        <Link href="https://www.linkedin.com/in/zelun-he-2b22351bb/" target="_blank" rel="noopener noreferrer">
